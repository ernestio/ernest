...
Feature: Environment destroy
  ...
  Scenario: Non logged environment destroy
    ...
    And I logout
    When I run ernest with "environment destroy"
  ...
  Scenario: Logged environment destroy unexisting
    ...
    When I run ernest with "environment destroy unexisting --yes"
  ...
  Scenario: Logged environment destroy
    ...
    When I run ernest with "environment destroy destroyable --yes"
