...
Feature: Environment apply
  ...
  Scenario: Remove a network and dettach an existing instance
    ...
    And all "instance.delete.vcloud-fake" messages should contain a credentials field "vcloud_vdc_name" with "fakevcloud"
    And all "instance.delete.vcloud-fake" messages should contain a credentials field "vcloud_url" with "https://vcloud.net"
    And all "instance.delete.vcloud-fake" messages should contain a credentials field "vcloud_username" with "fakeuser@test"
    And all "instance.delete.vcloud-fake" messages should contain an encrypted credentials field "vcloud_password" with "test123"
    ...
    And all "network.delete.vcloud-fake" messages should contain a credentials field "vcloud_vdc_name" with "fakevcloud"
    And all "network.delete.vcloud-fake" messages should contain a credentials field "vcloud_url" with "https://vcloud.net"
    And all "network.delete.vcloud-fake" messages should contain a credentials field "vcloud_username" with "fakeuser@test"
    And all "network.delete.vcloud-fake" messages should contain an encrypted credentials field "vcloud_password" with "test123"
