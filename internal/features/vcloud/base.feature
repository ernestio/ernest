...
Feature: Environment apply
  ...
  Scenario: Applying a basic environment
    ...
    And all "router.create.vcloud-fake" messages should contain a credentials field "vcloud_vdc_name" with "fakevcloud"
    And all "router.create.vcloud-fake" messages should contain a credentials field "vcloud_url" with "https://vcloud.net"
    And all "router.create.vcloud-fake" messages should contain a credentials field "vcloud_username" with "fakeuser@test"
    And all "router.create.vcloud-fake" messages should contain an encrypted credentials field "vcloud_password" with "test123"
