...
Feature: Environment apply
  ...
  Scenario: Add a network and attach a new instance
    ...
    And all "network.create.vcloud-fake" messages should contain a credentials field "vcloud_vdc_name" with "fakevcloud"
    And all "network.create.vcloud-fake" messages should contain a credentials field "vcloud_url" with "https://vcloud.net"
    And all "network.create.vcloud-fake" messages should contain a credentials field "vcloud_username" with "fakeuser@test"
    And all "network.create.vcloud-fake" messages should contain an encrypted credentials field "vcloud_password" with "test123"
    ...
    And all "instance.create.vcloud-fake" messages should contain a credentials field "vcloud_url" with "https://vcloud.net"
    And all "instance.create.vcloud-fake" messages should contain a credentials field "vcloud_vdc_name" with "fakevcloud"
    And all "instance.create.vcloud-fake" messages should contain a credentials field "vcloud_username" with "fakeuser@test"
    And all "instance.create.vcloud-fake" messages should contain an encrypted credentials field "vcloud_password" with "test123"
