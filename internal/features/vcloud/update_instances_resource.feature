...
Feature: Environment apply
  ...
  Scenario: Update existing instance ram and cpu
    ...
    And all "instance.update.vcloud-fake" messages should contain a credentials field "vcloud_vdc_name" with "fakevcloud"
    And all "instance.update.vcloud-fake" messages should contain a credentials field "vcloud_url" with "https://vcloud.net"
    And all "instance.update.vcloud-fake" messages should contain a credentials field "vcloud_username" with "fakeuser@test"
    And all "instance.update.vcloud-fake" messages should contain an encrypted credentials field "vcloud_password" with "test123"
