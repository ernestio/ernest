...
Feature: Creator
  ...
  Scenario: Applying a basic azure environment
    ...
    And message "storage_container.create.azure-fake" number "0" should contain "storage_account_name" as json field "storage1"
    ...
    And message "storage_account.create.azure-fake" number "0" should contain "_component_id" as json field "storage_account::storage1"
    ...
    And message "storage_account.create.azure-fake.done" number "0" should contain "_component_id" as json field "storage_account::storage1"
    ...
    And message "storage_container.create.azure-fake.done" number "0" should contain "storage_account_name" as json field "storage1"
    And an event "network_interface.delete.azure-fake" should be called exactly "1" times
    And message "network_interface.delete.azure-fake" number "0" should contain "_provider" as json field "azure-fake"
    And message "network_interface.delete.azure-fake" number "0" should contain "resource_group_name" as json field "az-test"
    And message "network_interface.delete.azure-fake" number "0" should contain "virtual_machine_id" as json field "virtual_machine::web"
    And message "network_interface.delete.azure-fake" number "0" should contain "_state" as json field "running"
    And message "network_interface.delete.azure-fake" number "0" should contain "datacenter_region" as json field "westus"
    And message "network_interface.delete.azure-fake" number "0" should contain "datacenter_type" as json field "azure-fake"
    And message "network_interface.delete.azure-fake" number "0" should contain "_action" as json field "delete"
    And message "network_interface.delete.azure-fake" number "0" should contain "_component" as json field "network_interface"
    And message "network_interface.delete.azure-fake" number "0" should contain "_component_id" as json field "network_interface::web-2"
    And message "network_interface.delete.azure-fake" number "0" should contain "location" as json field "westeurope"
    And message "network_interface.delete.azure-fake" number "0" should contain "datacenter_name" as json field "fakeazure"
    And an event "public_ip.delete.azure-fake" should be called exactly "1" times
    And message "public_ip.delete.azure-fake" number "0" should contain "_component_id" as json field "public_ip::web-2-config1"
    And message "public_ip.delete.azure-fake" number "0" should contain "datacenter_region" as json field "westus"
    And message "public_ip.delete.azure-fake" number "0" should contain "public_ip_address_allocation" as json field "static"
    And message "public_ip.delete.azure-fake" number "0" should contain "_provider" as json field "azure-fake"
    And message "public_ip.delete.azure-fake" number "0" should contain "resource_group_name" as json field "az-test"
    And message "public_ip.delete.azure-fake" number "0" should contain "_component" as json field "public_ip"
    And message "public_ip.delete.azure-fake" number "0" should contain "datacenter_type" as json field "azure-fake"
    ...
    And message "public_ip.delete.azure-fake" number "0" should contain "_state" as json field "running"
    And message "public_ip.delete.azure-fake" number "0" should contain "location" as json field "westeurope"
    And an event "network_interface.delete.azure-fake.done" should be called exactly "1" times
    And message "network_interface.delete.azure-fake.done" number "0" should contain "_provider" as json field "azure-fake"
    And message "network_interface.delete.azure-fake.done" number "0" should contain "resource_group_name" as json field "az-test"
    And message "network_interface.delete.azure-fake.done" number "0" should contain "virtual_machine_id" as json field "virtual_machine::web"
    And message "network_interface.delete.azure-fake.done" number "0" should contain "_component" as json field "network_interface"
    And message "network_interface.delete.azure-fake.done" number "0" should contain "location" as json field "westeurope"
    And message "network_interface.delete.azure-fake.done" number "0" should contain "type" as json field "network_interface.delete.azure-fake.done"
    And message "network_interface.delete.azure-fake.done" number "0" should contain "_component_id" as json field "network_interface::web-2"
    And message "network_interface.delete.azure-fake.done" number "0" should contain "datacenter_region" as json field "westus"
    And message "network_interface.delete.azure-fake.done" number "0" should contain "datacenter_name" as json field "fakeazure"
    ...
    And message "public_ip.delete.azure-fake.done" number "0" should contain "datacenter_name" as json field "fakeazure"
    ...
    And message "public_ip.delete.azure-fake.done" number "0" should contain "type" as json field "public_ip.delete.azure-fake.done"
    And message "public_ip.delete.azure-fake.done" number "0" should contain "_provider" as json field "azure-fake"
    And message "public_ip.delete.azure-fake.done" number "0" should contain "location" as json field "westeurope"
    And message "public_ip.delete.azure-fake.done" number "0" should contain "_action" as json field "delete"
    And message "public_ip.delete.azure-fake.done" number "0" should contain "resource_group_name" as json field "az-test"
    And message "public_ip.delete.azure-fake.done" number "0" should contain "_component" as json field "public_ip"
    And an event "virtual_machine.delete.azure-fake.done" should be called exactly "1" times
    And message "virtual_machine.delete.azure-fake.done" number "0" should contain "_action" as json field "delete"
    And message "virtual_machine.delete.azure-fake.done" number "0" should contain "datacenter_region" as json field "westus"
    And message "virtual_machine.delete.azure-fake.done" number "0" should contain "availability_set" as json field "web"
    And message "virtual_machine.delete.azure-fake.done" number "0" should contain "_component" as json field "virtual_machine"
    And message "virtual_machine.delete.azure-fake.done" number "0" should contain "_provider" as json field "azure-fake"
    And message "virtual_machine.delete.azure-fake.done" number "0" should contain "datacenter_name" as json field "fakeazure"
    And message "virtual_machine.delete.azure-fake.done" number "0" should contain "datacenter_type" as json field "azure-fake"
    And message "virtual_machine.delete.azure-fake.done" number "0" should contain "resource_group_name" as json field "az-test"
    And message "virtual_machine.delete.azure-fake.done" number "0" should contain "_component_id" as json field "virtual_machine::web-2"
    And message "virtual_machine.delete.azure-fake.done" number "0" should contain "_state" as json field "completed"
    And message "virtual_machine.delete.azure-fake.done" number "0" should contain "availability_set_id" as json field "$(components.#[_component_id="availability_set::web"].id)"
    And message "virtual_machine.delete.azure-fake.done" number "0" should contain "location" as json field "westeurope"
    And message "virtual_machine.delete.azure-fake.done" number "0" should contain "type" as json field "virtual_machine.delete.azure-fake.done"
    And message "virtual_machine.delete.azure-fake.done" number "0" should contain "vm_size" as json field "Standard_DS2_v2"
    And an event "virtual_machine.create.azure-fake" should be called exactly "2" times
    And message "virtual_machine.create.azure-fake" number "0" should contain "_component" as json field "virtual_machine"
    And message "virtual_machine.create.azure-fake" number "0" should contain "datacenter_type" as json field "azure-fake"
    And message "virtual_machine.create.azure-fake" number "0" should contain "vm_size" as json field "Standard_DS1_v2"
    ...
    And message "virtual_machine.delete.azure-fake" number "0" should contain "availability_set_id" as json field "$(components.#[_component_id="availability_set::web"].id)"
    And message "virtual_machine.delete.azure-fake" number "0" should contain "vm_size" as json field "Standard_DS2_v2"
    And message "virtual_machine.delete.azure-fake" number "0" should contain "_provider" as json field "azure-fake"
    And message "virtual_machine.delete.azure-fake" number "0" should contain "availability_set" as json field "web"
    And message "virtual_machine.delete.azure-fake" number "0" should contain "datacenter_region" as json field "westus"
    And message "virtual_machine.delete.azure-fake" number "0" should contain "location" as json field "westeurope"
    And message "virtual_machine.delete.azure-fake" number "0" should contain "_component" as json field "virtual_machine"
    And message "virtual_machine.delete.azure-fake" number "0" should contain "datacenter_name" as json field "fakeazure"
    And message "virtual_machine.delete.azure-fake" number "0" should contain "resource_group_name" as json field "az-test"
    And message "virtual_machine.delete.azure-fake" number "0" should contain "datacenter_type" as json field "azure-fake"
    And message "virtual_machine.delete.azure-fake" number "0" should contain "_action" as json field "delete"
    And message "virtual_machine.delete.azure-fake" number "0" should contain "_component_id" as json field "virtual_machine::web-2"
    ...
    And message "sql_database.create.azure-fake" number "0" should contain "server_name" as json field "sql1"
    ...
    And message "network_interface.delete.azure-fake" number "0" should contain "_state" as json field "running"
    And message "network_interface.delete.azure-fake" number "0" should contain "datacenter_name" as json field "fakeazure"
    And message "network_interface.delete.azure-fake" number "0" should contain "virtual_machine_id" as json field "virtual_machine::win"
    And message "network_interface.delete.azure-fake" number "0" should contain "_component_id" as json field "network_interface::win-2"
    And message "network_interface.delete.azure-fake" number "0" should contain "datacenter_region" as json field "westus"
    And message "network_interface.delete.azure-fake" number "0" should contain "location" as json field "westeurope"
    And message "network_interface.delete.azure-fake" number "0" should contain "_provider" as json field "azure-fake"
    And message "network_interface.delete.azure-fake" number "0" should contain "datacenter_type" as json field "azure-fake"
    And message "network_interface.delete.azure-fake" number "0" should contain "network_security_group" as json field "vm-sg"
    ...
    And message "virtual_machine.delete.azure-fake" number "0" should contain "datacenter_name" as json field "fakeazure"
    And message "virtual_machine.delete.azure-fake" number "0" should contain "datacenter_type" as json field "azure-fake"
    And message "virtual_machine.delete.azure-fake" number "0" should contain "_component_id" as json field "virtual_machine::win-2"
    And message "virtual_machine.delete.azure-fake" number "0" should contain "vm_size" as json field "Standard_DS1_v2"
    And an event "virtual_machine.delete.azure-fake.done" should be called exactly "1" times
    And message "virtual_machine.delete.azure-fake.done" number "0" should contain "_component" as json field "virtual_machine"
    And message "virtual_machine.delete.azure-fake.done" number "0" should contain "datacenter_type" as json field "azure-fake"
    And message "virtual_machine.delete.azure-fake.done" number "0" should contain "location" as json field "westeurope"
    ...
    And message "virtual_machine.delete.azure-fake.done" number "0" should contain "_action" as json field "delete"
    And message "virtual_machine.delete.azure-fake.done" number "0" should contain "resource_group_name" as json field "az-test"
    And message "virtual_machine.delete.azure-fake.done" number "0" should contain "_component_id" as json field "virtual_machine::win-2"
    And message "virtual_machine.delete.azure-fake.done" number "0" should contain "type" as json field "virtual_machine.delete.azure-fake.done"
    And message "virtual_machine.delete.azure-fake.done" number "0" should contain "_provider" as json field "azure-fake"
    And message "virtual_machine.delete.azure-fake.done" number "0" should contain "vm_size" as json field "Standard_DS1_v2"
    And message "virtual_machine.delete.azure-fake.done" number "0" should contain "_state" as json field "completed"
    And message "virtual_machine.delete.azure-fake.done" number "0" should contain "datacenter_region" as json field "westus"
    And an event "sql_server.create.azure-fake.done" should be called exactly "1" times
    And message "sql_server.create.azure-fake.done" number "0" should contain "_component_id" as json field "sql_server::sql1"
    ...
    And message "sql_database.create.azure-fake.done" number "0" should contain "server_name" as json field "sql1"
    ...
    And message "sql_firewall_rule.create.azure-fake.done" number "0" should contain "server_name" as json field "sql1"
    ...
    And message "public_ip.delete.azure-fake" number "0" should contain "resource_group_name" as json field "az-test"
    And message "public_ip.delete.azure-fake" number "0" should contain "datacenter_region" as json field "westus"
    And message "public_ip.delete.azure-fake" number "0" should contain "_component_id" as json field "public_ip::win-2-config1"
    And message "public_ip.delete.azure-fake" number "0" should contain "_state" as json field "running"
    And message "public_ip.delete.azure-fake" number "0" should contain "datacenter_type" as json field "azure-fake"
    And message "public_ip.delete.azure-fake" number "0" should contain "location" as json field "westeurope"
    And an event "public_ip.delete.azure-fake.done" should be called exactly "1" times
    ...
    And message "public_ip.delete.azure-fake.done" number "0" should contain "location" as json field "westeurope"
    And message "public_ip.delete.azure-fake.done" number "0" should contain "_component" as json field "public_ip"
    And message "public_ip.delete.azure-fake.done" number "0" should contain "_component_id" as json field "public_ip::win-2-config1"
    And message "public_ip.delete.azure-fake.done" number "0" should contain "datacenter_type" as json field "azure-fake"
    And message "public_ip.delete.azure-fake.done" number "0" should contain "_action" as json field "delete"
    And message "public_ip.delete.azure-fake.done" number "0" should contain "resource_group_name" as json field "az-test"
    And message "public_ip.delete.azure-fake.done" number "0" should contain "_provider" as json field "azure-fake"
    ...
    And message "sql_server.create.azure-fake" number "0" should contain "_component_id" as json field "sql_server::sql1"
    ...
    And message "sql_firewall_rule.create.azure-fake" number "0" should contain "server_name" as json field "sql1"
    ...
    And message "network_interface.delete.azure-fake.done" number "0" should contain "type" as json field "network_interface.delete.azure-fake.done"
    And message "network_interface.delete.azure-fake.done" number "0" should contain "_action" as json field "delete"
    And message "network_interface.delete.azure-fake.done" number "0" should contain "_component_id" as json field "network_interface::win-2"
    And message "network_interface.delete.azure-fake.done" number "0" should contain "datacenter_region" as json field "westus"
    And message "network_interface.delete.azure-fake.done" number "0" should contain "datacenter_type" as json field "azure-fake"
    And message "network_interface.delete.azure-fake.done" number "0" should contain "network_security_group_id" as json field "$(components.#[_component_id="security_group::vm-sg"].id)"
    And message "network_interface.delete.azure-fake.done" number "0" should contain "network_security_group" as json field "vm-sg"
    And message "network_interface.delete.azure-fake.done" number "0" should contain "datacenter_name" as json field "fakeazure"
    And message "network_interface.delete.azure-fake.done" number "0" should contain "virtual_machine_id" as json field "virtual_machine::win"
    And message "network_interface.delete.azure-fake.done" number "0" should contain "_component" as json field "network_interface"
    And message "network_interface.delete.azure-fake.done" number "0" should contain "_state" as json field "completed"
    And I start recording
    ...
    And message "lb_rule.delete.azure-fake.done" number "0" should contain "loadbalancer_id" as json field "$(components.#[_component_id="lb::lb"].id)"
    And message "lb_rule.delete.azure-fake.done" number "0" should contain "datacenter_region" as json field "westus"
    And message "lb_rule.delete.azure-fake.done" number "0" should contain "backend_address_pool_id" as json field "$(components.#[_component_id="lb_backend_address_pool::pool1"].id)"
    And message "lb_rule.delete.azure-fake.done" number "0" should contain "frontend_ip_configuration_name" as json field "lbip"
    And message "lb_rule.delete.azure-fake.done" number "0" should contain "probe" as json field "http"
    And message "lb_rule.delete.azure-fake.done" number "0" should contain "type" as json field "lb_rule.delete.azure-fake.done"
    And message "lb_rule.delete.azure-fake.done" number "0" should contain "backend_address_pool" as json field "pool1"
    And message "lb_rule.delete.azure-fake.done" number "0" should contain "_state" as json field "completed"
    And message "lb_rule.delete.azure-fake.done" number "0" should contain "_action" as json field "delete"
    And message "lb_rule.delete.azure-fake.done" number "0" should contain "_provider" as json field "azure-fake"
    And message "lb_rule.delete.azure-fake.done" number "0" should contain "probe_id" as json field "$(components.#[_component_id="lb_probe::http"].id)"
    And message "lb_rule.delete.azure-fake.done" number "0" should contain "_component" as json field "lb_rule"
    And message "lb_rule.delete.azure-fake.done" number "0" should contain "datacenter_name" as json field "fakeazure"
    And message "lb_rule.delete.azure-fake.done" number "0" should contain "protocol" as json field "Tcp"
    And message "lb_rule.delete.azure-fake.done" number "0" should contain "datacenter_type" as json field "azure-fake"
    And message "lb_rule.delete.azure-fake.done" number "0" should contain "resource_group_name" as json field "az-test"
    And an event "network_interface.delete.azure-fake" should be called exactly "1" times
    And message "network_interface.delete.azure-fake" number "0" should contain "_action" as json field "delete"
    And message "network_interface.delete.azure-fake" number "0" should contain "_state" as json field "running"
    And message "network_interface.delete.azure-fake" number "0" should contain "_component_id" as json field "network_interface::web-1"
    And message "network_interface.delete.azure-fake" number "0" should contain "datacenter_region" as json field "westus"
    And message "network_interface.delete.azure-fake" number "0" should contain "datacenter_type" as json field "azure-fake"
    And message "network_interface.delete.azure-fake" number "0" should contain "_provider" as json field "azure-fake"
    And message "network_interface.delete.azure-fake" number "0" should contain "location" as json field "westeurope"
    ...
    And message "network_interface.delete.azure-fake.done" number "0" should contain "_action" as json field "delete"
    And message "network_interface.delete.azure-fake.done" number "0" should contain "_component" as json field "network_interface"
    And message "network_interface.delete.azure-fake.done" number "0" should contain "_component_id" as json field "network_interface::web-1"
    And message "network_interface.delete.azure-fake.done" number "0" should contain "location" as json field "westeurope"
    And message "network_interface.delete.azure-fake.done" number "0" should contain "_provider" as json field "azure-fake"
    And message "network_interface.delete.azure-fake.done" number "0" should contain "virtual_machine_id" as json field "virtual_machine::web"
    And message "network_interface.delete.azure-fake.done" number "0" should contain "type" as json field "network_interface.delete.azure-fake.done"
    And message "network_interface.delete.azure-fake.done" number "0" should contain "_state" as json field "completed"
    And an event "lb_backend_address_pool.delete.azure-fake" should be called exactly "1" times
    And message "lb_backend_address_pool.delete.azure-fake" number "0" should contain "_action" as json field "delete"
    And message "lb_backend_address_pool.delete.azure-fake" number "0" should contain "datacenter_name" as json field "fakeazure"
    And message "lb_backend_address_pool.delete.azure-fake" number "0" should contain "datacenter_region" as json field "westus"
    And message "lb_backend_address_pool.delete.azure-fake" number "0" should contain "_state" as json field "running"
    And message "lb_backend_address_pool.delete.azure-fake" number "0" should contain "datacenter_type" as json field "azure-fake"
    And message "lb_backend_address_pool.delete.azure-fake" number "0" should contain "loadbalancer_id" as json field "$(components.#[_component_id="lb::lb"].id)"
    And message "lb_backend_address_pool.delete.azure-fake" number "0" should contain "resource_group_name" as json field "az-test"
    And message "lb_backend_address_pool.delete.azure-fake" number "0" should contain "_component" as json field "lb_backend_address_pool"
    ...
    And message "network_interface.create.azure-fake.done" number "0" should contain "datacenter_type" as json field "azure-fake"
    And an event "availability_set.delete.azure-fake" should be called exactly "1" times
    And message "availability_set.delete.azure-fake" number "0" should contain "_component_id" as json field "availability_set::web"
    And message "availability_set.delete.azure-fake" number "0" should contain "datacenter_name" as json field "fakeazure"
    And message "availability_set.delete.azure-fake" number "0" should contain "location" as json field "westeurope"
    And message "availability_set.delete.azure-fake" number "0" should contain "_action" as json field "delete"
    And message "availability_set.delete.azure-fake" number "0" should contain "_component" as json field "availability_set"
    And message "availability_set.delete.azure-fake" number "0" should contain "resource_group_name" as json field "az-test"
    And message "availability_set.delete.azure-fake" number "0" should contain "datacenter_type" as json field "azure-fake"
    ...
    And message "public_ip.delete.azure-fake.done" number "0" should contain "_state" as json field "completed"
    And message "public_ip.delete.azure-fake.done" number "0" should contain "_action" as json field "delete"
    And message "public_ip.delete.azure-fake.done" number "0" should contain "_component_id" as json field "public_ip::web-1-config1"
    And message "public_ip.delete.azure-fake.done" number "0" should contain "datacenter_region" as json field "westus"
    And message "public_ip.delete.azure-fake.done" number "0" should contain "resource_group_name" as json field "az-test"
    And message "public_ip.delete.azure-fake.done" number "0" should contain "type" as json field "public_ip.delete.azure-fake.done"
    And message "public_ip.delete.azure-fake.done" number "1" should contain "_component_id" as json field "public_ip::lb-lbip"
    And message "public_ip.delete.azure-fake.done" number "1" should contain "_action" as json field "delete"
    And message "public_ip.delete.azure-fake.done" number "1" should contain "datacenter_name" as json field "fakeazure"
    And message "public_ip.delete.azure-fake.done" number "1" should contain "type" as json field "public_ip.delete.azure-fake.done"
    And message "public_ip.delete.azure-fake.done" number "1" should contain "_component" as json field "public_ip"
    And message "public_ip.delete.azure-fake.done" number "1" should contain "location" as json field "westeurope"
    And message "public_ip.delete.azure-fake.done" number "1" should contain "datacenter_region" as json field "westus"
    And message "public_ip.delete.azure-fake.done" number "1" should contain "public_ip_address_allocation" as json field "static"
    And message "public_ip.delete.azure-fake.done" number "1" should contain "resource_group_name" as json field "az-test"
    And message "public_ip.delete.azure-fake.done" number "1" should contain "_state" as json field "completed"
    And message "public_ip.delete.azure-fake.done" number "1" should contain "datacenter_type" as json field "azure-fake"
    And message "public_ip.delete.azure-fake.done" number "1" should contain "_provider" as json field "azure-fake"
    ...
    And message "virtual_machine.create.azure-fake" number "0" should contain "datacenter_type" as json field "azure-fake"
    And an event "lb.delete.azure-fake" should be called exactly "1" times
    And message "lb.delete.azure-fake" number "0" should contain "datacenter_name" as json field "fakeazure"
    And message "lb.delete.azure-fake" number "0" should contain "datacenter_type" as json field "azure-fake"
    And message "lb.delete.azure-fake" number "0" should contain "datacenter_region" as json field "westus"
    And message "lb.delete.azure-fake" number "0" should contain "location" as json field "westeurope"
    And message "lb.delete.azure-fake" number "0" should contain "_component_id" as json field "lb::lb"
    And message "lb.delete.azure-fake" number "0" should contain "_provider" as json field "azure-fake"
    And message "lb.delete.azure-fake" number "0" should contain "resource_group_name" as json field "az-test"
    And message "lb.delete.azure-fake" number "0" should contain "_action" as json field "delete"
    And message "lb.delete.azure-fake" number "0" should contain "_component" as json field "lb"
    And message "lb.delete.azure-fake" number "0" should contain "_state" as json field "running"
    And an event "lb_rule.delete.azure-fake" should be called exactly "1" times
    And message "lb_rule.delete.azure-fake" number "0" should contain "backend_address_pool" as json field "pool1"
    And message "lb_rule.delete.azure-fake" number "0" should contain "datacenter_type" as json field "azure-fake"
    And message "lb_rule.delete.azure-fake" number "0" should contain "frontend_ip_configuration_name" as json field "lbip"
    And message "lb_rule.delete.azure-fake" number "0" should contain "_state" as json field "running"
    And message "lb_rule.delete.azure-fake" number "0" should contain "loadbalancer_id" as json field "$(components.#[_component_id="lb::lb"].id)"
    And message "lb_rule.delete.azure-fake" number "0" should contain "protocol" as json field "Tcp"
    And message "lb_rule.delete.azure-fake" number "0" should contain "_action" as json field "delete"
    And message "lb_rule.delete.azure-fake" number "0" should contain "resource_group_name" as json field "az-test"
    And message "lb_rule.delete.azure-fake" number "0" should contain "_component" as json field "lb_rule"
    And message "lb_rule.delete.azure-fake" number "0" should contain "_provider" as json field "azure-fake"
    And message "lb_rule.delete.azure-fake" number "0" should contain "probe_id" as json field "$(components.#[_component_id="lb_probe::http"].id)"
    And message "lb_rule.delete.azure-fake" number "0" should contain "_component_id" as json field "lb_rule::http"
    And message "lb_rule.delete.azure-fake" number "0" should contain "datacenter_name" as json field "fakeazure"
    And message "lb_rule.delete.azure-fake" number "0" should contain "loadbalancer" as json field "lb"
    And message "lb_rule.delete.azure-fake" number "0" should contain "backend_address_pool_id" as json field "$(components.#[_component_id="lb_backend_address_pool::pool1"].id)"
    And message "lb_rule.delete.azure-fake" number "0" should contain "datacenter_region" as json field "westus"
    And message "lb_rule.delete.azure-fake" number "0" should contain "probe" as json field "http"
    And an event "virtual_machine.delete.azure-fake" should be called exactly "1" times
    And message "virtual_machine.delete.azure-fake" number "0" should contain "_action" as json field "delete"
    And message "virtual_machine.delete.azure-fake" number "0" should contain "availability_set_id" as json field "$(components.#[_component_id="availability_set::web"].id)"
    And message "virtual_machine.delete.azure-fake" number "0" should contain "availability_set" as json field "web"
    ...
    And message "virtual_machine.delete.azure-fake" number "0" should contain "resource_group_name" as json field "az-test"
    And message "virtual_machine.delete.azure-fake" number "0" should contain "_component" as json field "virtual_machine"
    And message "virtual_machine.delete.azure-fake" number "0" should contain "_component_id" as json field "virtual_machine::web-1"
    And message "virtual_machine.delete.azure-fake" number "0" should contain "_state" as json field "running"
    ...
    And message "public_ip.create.azure-fake" number "0" should contain "datacenter_type" as json field "azure-fake"
    And message "public_ip.create.azure-fake" number "0" should contain "_provider" as json field "azure-fake"
    And an event "availability_set.delete.azure-fake.done" should be called exactly "1" times
    And message "availability_set.delete.azure-fake.done" number "0" should contain "_component" as json field "availability_set"
    And message "availability_set.delete.azure-fake.done" number "0" should contain "datacenter_type" as json field "azure-fake"
    And message "availability_set.delete.azure-fake.done" number "0" should contain "resource_group_name" as json field "az-test"
    And message "availability_set.delete.azure-fake.done" number "0" should contain "type" as json field "availability_set.delete.azure-fake.done"
    And message "availability_set.delete.azure-fake.done" number "0" should contain "location" as json field "westeurope"
    And message "availability_set.delete.azure-fake.done" number "0" should contain "_action" as json field "delete"
    And message "availability_set.delete.azure-fake.done" number "0" should contain "_state" as json field "completed"
    And message "availability_set.delete.azure-fake.done" number "0" should contain "datacenter_name" as json field "fakeazure"
    And message "availability_set.delete.azure-fake.done" number "0" should contain "_component_id" as json field "availability_set::web"
    And message "availability_set.delete.azure-fake.done" number "0" should contain "_provider" as json field "azure-fake"
    And message "availability_set.delete.azure-fake.done" number "0" should contain "datacenter_region" as json field "westus"
    And an event "public_ip.delete.azure-fake" should be called exactly "2" times
    And message "public_ip.delete.azure-fake" number "0" should contain "_component" as json field "public_ip"
    And message "public_ip.delete.azure-fake" number "0" should contain "datacenter_region" as json field "westus"
    And message "public_ip.delete.azure-fake" number "0" should contain "datacenter_type" as json field "azure-fake"
    And message "public_ip.delete.azure-fake" number "0" should contain "_provider" as json field "azure-fake"
    And message "public_ip.delete.azure-fake" number "0" should contain "resource_group_name" as json field "az-test"
    And message "public_ip.delete.azure-fake" number "0" should contain "_component_id" as json field "public_ip::web-1-config1"
    And message "public_ip.delete.azure-fake" number "0" should contain "_state" as json field "running"
    And message "public_ip.delete.azure-fake" number "0" should contain "location" as json field "westeurope"
    And message "public_ip.delete.azure-fake" number "0" should contain "public_ip_address_allocation" as json field "static"
    And message "public_ip.delete.azure-fake" number "0" should contain "_action" as json field "delete"
    And message "public_ip.delete.azure-fake" number "0" should contain "datacenter_name" as json field "fakeazure"
    And message "public_ip.delete.azure-fake" number "1" should contain "_action" as json field "delete"
    And message "public_ip.delete.azure-fake" number "1" should contain "_component_id" as json field "public_ip::lb-lbip"
    And message "public_ip.delete.azure-fake" number "1" should contain "datacenter_name" as json field "fakeazure"
    And message "public_ip.delete.azure-fake" number "1" should contain "datacenter_region" as json field "westus"
    And message "public_ip.delete.azure-fake" number "1" should contain "location" as json field "westeurope"
    And message "public_ip.delete.azure-fake" number "1" should contain "public_ip_address_allocation" as json field "static"
    And message "public_ip.delete.azure-fake" number "1" should contain "_component" as json field "public_ip"
    And message "public_ip.delete.azure-fake" number "1" should contain "_provider" as json field "azure-fake"
    And message "public_ip.delete.azure-fake" number "1" should contain "_state" as json field "running"
    And message "public_ip.delete.azure-fake" number "1" should contain "resource_group_name" as json field "az-test"
    And message "public_ip.delete.azure-fake" number "1" should contain "datacenter_type" as json field "azure-fake"
    And an event "virtual_machine.delete.azure-fake.done" should be called exactly "1" times
    And message "virtual_machine.delete.azure-fake.done" number "0" should contain "availability_set_id" as json field "$(components.#[_component_id="availability_set::web"].id)"
    And message "virtual_machine.delete.azure-fake.done" number "0" should contain "resource_group_name" as json field "az-test"
    And message "virtual_machine.delete.azure-fake.done" number "0" should contain "availability_set" as json field "web"
    ...
    And message "virtual_machine.delete.azure-fake.done" number "0" should contain "location" as json field "westeurope"
    And message "virtual_machine.delete.azure-fake.done" number "0" should contain "_component" as json field "virtual_machine"
    And message "virtual_machine.delete.azure-fake.done" number "0" should contain "_component_id" as json field "virtual_machine::web-1"
    And message "virtual_machine.delete.azure-fake.done" number "0" should contain "datacenter_name" as json field "fakeazure"
    And message "virtual_machine.delete.azure-fake.done" number "0" should contain "_provider" as json field "azure-fake"
    And message "virtual_machine.delete.azure-fake.done" number "0" should contain "_state" as json field "completed"
    And message "virtual_machine.delete.azure-fake.done" number "0" should contain "datacenter_region" as json field "westus"
    ...
    And message "virtual_machine.create.azure-fake.done" number "0" should contain "resource_group_name" as json field "az-test"
    And message "virtual_machine.create.azure-fake.done" number "0" should contain "vm_size" as json field "Standard_DS1_v2"
    And an event "security_group.delete.azure-fake" should be called exactly "1" times
    And message "security_group.delete.azure-fake" number "0" should contain "location" as json field "westeurope"
    And message "security_group.delete.azure-fake" number "0" should contain "_provider" as json field "azure-fake"
    And message "security_group.delete.azure-fake" number "0" should contain "datacenter_name" as json field "fakeazure"
    And message "security_group.delete.azure-fake" number "0" should contain "datacenter_region" as json field "westus"
    And message "security_group.delete.azure-fake" number "0" should contain "resource_group_name" as json field "az-test"
    And message "security_group.delete.azure-fake" number "0" should contain "_action" as json field "delete"
    And message "security_group.delete.azure-fake" number "0" should contain "_component" as json field "security_group"
    And message "security_group.delete.azure-fake" number "0" should contain "_component_id" as json field "security_group::subnet-sg"
    And message "security_group.delete.azure-fake" number "0" should contain "_state" as json field "running"
    And message "security_group.delete.azure-fake" number "0" should contain "datacenter_type" as json field "azure-fake"
    And an event "lb_probe.delete.azure-fake.done" should be called exactly "1" times
    And message "lb_probe.delete.azure-fake.done" number "0" should contain "_component_id" as json field "lb_probe::http"
    And message "lb_probe.delete.azure-fake.done" number "0" should contain "_provider" as json field "azure-fake"
    And message "lb_probe.delete.azure-fake.done" number "0" should contain "datacenter_region" as json field "westus"
    And message "lb_probe.delete.azure-fake.done" number "0" should contain "protocol" as json field "Http"
    And message "lb_probe.delete.azure-fake.done" number "0" should contain "_component" as json field "lb_probe"
    And message "lb_probe.delete.azure-fake.done" number "0" should contain "loadbalancer_id" as json field "$(components.#[_component_id="lb::lb"].id)"
    And message "lb_probe.delete.azure-fake.done" number "0" should contain "_action" as json field "delete"
    And message "lb_probe.delete.azure-fake.done" number "0" should contain "request_path" as json field "/"
    And message "lb_probe.delete.azure-fake.done" number "0" should contain "datacenter_type" as json field "azure-fake"
    And message "lb_probe.delete.azure-fake.done" number "0" should contain "type" as json field "lb_probe.delete.azure-fake.done"
    And message "lb_probe.delete.azure-fake.done" number "0" should contain "_state" as json field "completed"
    And message "lb_probe.delete.azure-fake.done" number "0" should contain "loadbalancer" as json field "lb"
    And message "lb_probe.delete.azure-fake.done" number "0" should contain "resource_group_name" as json field "az-test"
    And message "lb_probe.delete.azure-fake.done" number "0" should contain "datacenter_name" as json field "fakeazure"
    And an event "security_group.delete.azure-fake.done" should be called exactly "1" times
    And message "security_group.delete.azure-fake.done" number "0" should contain "_component" as json field "security_group"
    And message "security_group.delete.azure-fake.done" number "0" should contain "_component_id" as json field "security_group::subnet-sg"
    And message "security_group.delete.azure-fake.done" number "0" should contain "_state" as json field "completed"
    And message "security_group.delete.azure-fake.done" number "0" should contain "resource_group_name" as json field "az-test"
    And message "security_group.delete.azure-fake.done" number "0" should contain "_provider" as json field "azure-fake"
    And message "security_group.delete.azure-fake.done" number "0" should contain "type" as json field "security_group.delete.azure-fake.done"
    And message "security_group.delete.azure-fake.done" number "0" should contain "datacenter_name" as json field "fakeazure"
    And message "security_group.delete.azure-fake.done" number "0" should contain "datacenter_region" as json field "westus"
    And message "security_group.delete.azure-fake.done" number "0" should contain "_action" as json field "delete"
    And message "security_group.delete.azure-fake.done" number "0" should contain "datacenter_type" as json field "azure-fake"
    And message "security_group.delete.azure-fake.done" number "0" should contain "location" as json field "westeurope"
    And an event "lb.delete.azure-fake.done" should be called exactly "1" times
    And message "lb.delete.azure-fake.done" number "0" should contain "datacenter_type" as json field "azure-fake"
    And message "lb.delete.azure-fake.done" number "0" should contain "location" as json field "westeurope"
    And message "lb.delete.azure-fake.done" number "0" should contain "_provider" as json field "azure-fake"
    And message "lb.delete.azure-fake.done" number "0" should contain "datacenter_region" as json field "westus"
    And message "lb.delete.azure-fake.done" number "0" should contain "resource_group_name" as json field "az-test"
    And message "lb.delete.azure-fake.done" number "0" should contain "_action" as json field "delete"
    And message "lb.delete.azure-fake.done" number "0" should contain "_component_id" as json field "lb::lb"
    And message "lb.delete.azure-fake.done" number "0" should contain "type" as json field "lb.delete.azure-fake.done"
    And message "lb.delete.azure-fake.done" number "0" should contain "_component" as json field "lb"
    And message "lb.delete.azure-fake.done" number "0" should contain "_state" as json field "completed"
    And message "lb.delete.azure-fake.done" number "0" should contain "datacenter_name" as json field "fakeazure"
    ...
    And message "network_interface.create.azure-fake" number "0" should contain "location" as json field "westeurope"
    And message "network_interface.create.azure-fake" number "0" should contain "network_security_group_id" as json field "$(components.#[_component_id="security_group::vm-sg"].id)"
    And an event "lb_probe.delete.azure-fake" should be called exactly "1" times
    And message "lb_probe.delete.azure-fake" number "0" should contain "_action" as json field "delete"
    And message "lb_probe.delete.azure-fake" number "0" should contain "_component_id" as json field "lb_probe::http"
    And message "lb_probe.delete.azure-fake" number "0" should contain "_state" as json field "running"
    And message "lb_probe.delete.azure-fake" number "0" should contain "datacenter_type" as json field "azure-fake"
    And message "lb_probe.delete.azure-fake" number "0" should contain "resource_group_name" as json field "az-test"
    And message "lb_probe.delete.azure-fake" number "0" should contain "_provider" as json field "azure-fake"
    And message "lb_probe.delete.azure-fake" number "0" should contain "datacenter_name" as json field "fakeazure"
    And message "lb_probe.delete.azure-fake" number "0" should contain "datacenter_region" as json field "westus"
    And message "lb_probe.delete.azure-fake" number "0" should contain "protocol" as json field "Http"
    And message "lb_probe.delete.azure-fake" number "0" should contain "_component" as json field "lb_probe"
    And message "lb_probe.delete.azure-fake" number "0" should contain "loadbalancer_id" as json field "$(components.#[_component_id="lb::lb"].id)"
    And message "lb_probe.delete.azure-fake" number "0" should contain "loadbalancer" as json field "lb"
    And message "lb_probe.delete.azure-fake" number "0" should contain "request_path" as json field "/"
    And an event "lb_backend_address_pool.delete.azure-fake.done" should be called exactly "1" times
    And message "lb_backend_address_pool.delete.azure-fake.done" number "0" should contain "_component" as json field "lb_backend_address_pool"
    And message "lb_backend_address_pool.delete.azure-fake.done" number "0" should contain "datacenter_region" as json field "westus"
    And message "lb_backend_address_pool.delete.azure-fake.done" number "0" should contain "datacenter_type" as json field "azure-fake"
    And message "lb_backend_address_pool.delete.azure-fake.done" number "0" should contain "_provider" as json field "azure-fake"
    And message "lb_backend_address_pool.delete.azure-fake.done" number "0" should contain "loadbalancer_id" as json field "$(components.#[_component_id="lb::lb"].id)"
    And message "lb_backend_address_pool.delete.azure-fake.done" number "0" should contain "resource_group_name" as json field "az-test"
    And message "lb_backend_address_pool.delete.azure-fake.done" number "0" should contain "datacenter_name" as json field "fakeazure"
    And message "lb_backend_address_pool.delete.azure-fake.done" number "0" should contain "_state" as json field "completed"
    And message "lb_backend_address_pool.delete.azure-fake.done" number "0" should contain "loadbalancer" as json field "lb"
    And message "lb_backend_address_pool.delete.azure-fake.done" number "0" should contain "type" as json field "lb_backend_address_pool.delete.azure-fake.done"
    And message "lb_backend_address_pool.delete.azure-fake.done" number "0" should contain "_action" as json field "delete"
    And message "lb_backend_address_pool.delete.azure-fake.done" number "0" should contain "_component_id" as json field "lb_backend_address_pool::pool1"
    And an event "subnet.delete.azure-fake" should be called exactly "1" times
    And message "subnet.delete.azure-fake" number "0" should contain "_action" as json field "delete"
    And message "subnet.delete.azure-fake" number "0" should contain "address_prefix" as json field "10.0.1.0/24"
    And message "subnet.delete.azure-fake" number "0" should contain "datacenter_name" as json field "fakeazure"
    And message "subnet.delete.azure-fake" number "0" should contain "_component" as json field "subnet"
    And message "subnet.delete.azure-fake" number "0" should contain "network_security_group" as json field "subnet-sg"
    And message "subnet.delete.azure-fake" number "0" should contain "resource_group_name" as json field "az-test"
    And message "subnet.delete.azure-fake" number "0" should contain "network_security_group_id" as json field "$(components.#[_component_id="security_group::subnet-sg"].id)"
    And message "subnet.delete.azure-fake" number "0" should contain "_state" as json field "running"
    And message "subnet.delete.azure-fake" number "0" should contain "datacenter_region" as json field "westus"
    And message "subnet.delete.azure-fake" number "0" should contain "datacenter_type" as json field "azure-fake"
    And message "subnet.delete.azure-fake" number "0" should contain "virtual_network_name" as json field "net"
    And message "subnet.delete.azure-fake" number "0" should contain "_component_id" as json field "subnet::sub1"
    And message "subnet.delete.azure-fake" number "0" should contain "_provider" as json field "azure-fake"
    And an event "subnet.delete.azure-fake.done" should be called exactly "1" times
    And message "subnet.delete.azure-fake.done" number "0" should contain "_provider" as json field "azure-fake"
    And message "subnet.delete.azure-fake.done" number "0" should contain "_state" as json field "completed"
    And message "subnet.delete.azure-fake.done" number "0" should contain "network_security_group_id" as json field "$(components.#[_component_id="security_group::subnet-sg"].id)"
    And message "subnet.delete.azure-fake.done" number "0" should contain "_action" as json field "delete"
    And message "subnet.delete.azure-fake.done" number "0" should contain "_component" as json field "subnet"
    And message "subnet.delete.azure-fake.done" number "0" should contain "virtual_network_name" as json field "net"
    And message "subnet.delete.azure-fake.done" number "0" should contain "datacenter_region" as json field "westus"
    And message "subnet.delete.azure-fake.done" number "0" should contain "network_security_group" as json field "subnet-sg"
    And message "subnet.delete.azure-fake.done" number "0" should contain "type" as json field "subnet.delete.azure-fake.done"
    And message "subnet.delete.azure-fake.done" number "0" should contain "resource_group_name" as json field "az-test"
    And message "subnet.delete.azure-fake.done" number "0" should contain "datacenter_name" as json field "fakeazure"
    And message "subnet.delete.azure-fake.done" number "0" should contain "datacenter_type" as json field "azure-fake"
    And message "subnet.delete.azure-fake.done" number "0" should contain "_component_id" as json field "subnet::sub1"
    And message "subnet.delete.azure-fake.done" number "0" should contain "address_prefix" as json field "10.0.1.0/24"
