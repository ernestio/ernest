...
Feature: Service apply
  ...
  Scenario: Add engress security group to a instance
    ...
    And message "firewall.update.aws-fake" number "0" should contain "10.1.1.11/32" as json field "rules.egress.1.ip"
    And message "firewall.update.aws-fake" number "0" should contain "22" as json field "rules.egress.1.from_port"
    And message "firewall.update.aws-fake" number "0" should contain "22" as json field "rules.egress.1.to_port"
    And message "firewall.update.aws-fake" number "0" should contain "-1" as json field "rules.egress.1.protocol"
