...
Feature: Environment apply
  ...
  Scenario: delete an elb and an s3
    ...
    And message "s3.delete.aws-fake" number "0" should contain "foo@ernest.io" as json field "grantees.0.id"
    ...
    And message "s3.delete.aws-fake" number "0" should contain "bar@ernest.io" as json field "grantees.1.id"
