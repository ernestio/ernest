...
Feature: Service apply
  ...
  Scenario: Updating rds clusters
    ...
    And I apply the definition "aws21.yml"
    And I stop recording
    Then an event "rds_cluster.delete.aws-fake" should be called exactly "1" times
    ...
    And all "rds_cluster.delete.aws-fake" messages should contain a field "database_username" with "test"
    And all "rds_cluster.delete.aws-fake" messages should contain a field "database_password" with "testpass-2"
