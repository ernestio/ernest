...
ernest-cli project create vcloud fakevcloud -org test -user fakeuser -password test123 -vdc fakevcloud -vcloud-url https://vcloud.net --fake
ernest-cli project create azure --subscription_id subid --client_id cliid --client_secret clisec --tenant_id tenid --environment public --fake fakeazure
